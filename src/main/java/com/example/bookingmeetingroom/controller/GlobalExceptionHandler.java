...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorMessage> handleAccessDeniedException(AccessDeniedException exception, WebRequest request) {
        logger.error("No access rights: {}", exception.getMessage());
        return new ResponseEntity<>(buildError(HttpStatus.FORBIDDEN, exception, request), HttpStatus.FORBIDDEN);
    }
